from psac_manual_experiment import psac_manual_experiment
...
if __name__ == '__main__':
    ...
    tasks = [client.submit(psac_manual_experiment, "mdp_config_non_stat.json", 5 * i, 5 * i + 5) for i in range(n_workers)]
