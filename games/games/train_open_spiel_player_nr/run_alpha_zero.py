...
import games.train_open_spiel_player_nr.alpha_zero as alpha_zero
...
flags.DEFINE_integer("replay_buffer_size", 2**16, "How many states to store in the replay buffer.")
flags.DEFINE_integer("replay_buffer_reuse", 3, "How many times to learn from each state.")
...
flags.DEFINE_integer(
    "temperature_drop", 10, "Drop the temperature to 0 after this many moves."  # Less than AZ due to short games.
)
flags.DEFINE_enum("nn_model", "resnet", model_lib.Model.valid_model_types, "What type of model should be used?.")
...
flags.DEFINE_string("path", "models/az", "Where to save checkpoints.")
...
flags.DEFINE_integer("evaluation_window", 10, "How many games to average results over.")
flags.DEFINE_integer(
    "eval_levels",
    7,
    (
